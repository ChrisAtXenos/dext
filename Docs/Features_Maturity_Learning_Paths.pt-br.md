...
| **Dext Testing & Test Explorer** | 🟢 **Estável** | `Dext.Testing`, `Dext.Mocks`, `Dext.Testing.Runner`, RAD Studio Test Explorer Expert | Suíte completa com Assertions Fluentes, Mock de Classes/Interfaces, AutoMocker, Snapshots, Cobertura de Código (CLI/IDE) e integração nativa com a IDE. |
